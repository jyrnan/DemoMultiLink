...
#ifndef TESTMULTILINKSDK_SWIFT_H
#define TESTMULTILINKSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TestMultiLinkSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


/// 作为对底层的封装，可以实现SDK作用
SWIFT_CLASS("_TtC16TestMultiLinkSDK17YMLNetworkService")
@interface YMLNetworkService : NSObject
...
@interface YMLNetworkService (SWIFT_EXTENSION(TestMultiLinkSDK)) <GCDAsyncSocketDelegate>
/// 接收到新的Socket连接时的代理回调
/// \param sock 
///
/// \param newSocket 
...
@interface YMLNetworkService (SWIFT_EXTENSION(TestMultiLinkSDK)) <GCDAsyncUdpSocketDelegate>
/// 连接成功回调
